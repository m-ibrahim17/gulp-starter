...
$(document).ready(function (e) {
  ...
  var navOffset = $('#wideImage').offset().top;
...
new Vue({
  ...
  data: {
    ...
    faqs: [{
      ...
      body: ['Contact us at [email].', 'To join the pilot you’ll need to schedule session demo time. The session demo can be scheduled for a 1.5 hour session or a 2.5 hour session. Seeking Sierra provides experienced ESL schools that will go to your school, set up and run the session.']
    }, {
      id: 'faq_2',
      head: 'heading_2',
      title: 'Who are the instructors?',
      body: ['For the Seeking Sierra pilot, we provide experienced ESL teachers to run the sessions for students interested in the program. Instructors from the school interested in observing the program are welcome to join.', 'Seeking Sierra is designed to be used with the instructors at your school and comes with materials that walk through the program design. We additionally provide instructor training and support through consultations and demos.']
    }, {
      id: 'faq_3',
      head: 'heading_3',
      title: 'What\'s the pricing model?',
      body: ['The pilot is free.', 'After the startup session, Seeking Sierra will be offered as a subscription model to schools.        ']
    }, {
      id: 'faq_4',
      head: 'heading_4',
      title: 'What happens after the pilot?',
      body: ['After the pilot, we’ll incorporate feedback into our development and keep you up to date with future chapter rollouts. We’ll be completing a Season,  with content available for 3 months.']
    }, {
      id: 'faq_5',
      head: 'heading_5',
      title: 'My school has large class sizes, can I still use Seeking Sierra?',
      body: ['The initial version of Seeking Sierra will support classes of up to 4 students per instructor, and support for 8 students per instructor is planned shortly after.', 'We’re also exploring ways to support independent product use that will require lower student-teacher interaction time.']
    }]
  }
});
